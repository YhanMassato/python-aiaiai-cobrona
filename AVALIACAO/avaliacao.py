...
votosTotais = int(input("Número total de votos "))
...
if votosCandidato2 > votosCandidato1 and votosCandidato2 > votosCandidato3 :
...
if votosCandidato3 > votosCandidato2 and votosCandidato3 > votosCandidato1 :
...
if votosCandidato1 == votosCandidato3 and votosCandidato1 != votosCandidato2 :
